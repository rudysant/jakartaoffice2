...
from . models import Catalogues, Acquisition2, Book_source, Consignment, Tripplace, Fieldtrip
...
class TripplaceA(admin.ModelAdmin):
...
admin.site.register(Tripplace, TripplaceA)
